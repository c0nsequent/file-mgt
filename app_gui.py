...
class picture_window:
    ...
    def __init__(self):
        ...
        self.rooting = tk.Checkbutton(self.root,text='include underlying directories?',variable=self.rooting_var)
    ...
    def sync_pictures_in_folder(self):
        try:
            self.found_pictures = cl.find_pictures(self.picture_folder,root=self.rooting_var.get())
